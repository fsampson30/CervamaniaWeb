...
@WebServlet(name = "ServletConsultaCerveja", urlPatterns = {"/ServletConsultaCerveja"})
public class ServletConsultaCerveja extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {               
        try {
            ...
            cervejasSelecionadas = dao.pesquisaNomeCerveja(parametro);                                            
