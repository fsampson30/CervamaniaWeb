...
@WebServlet(name = "ServletConsultaCervejaPais", urlPatterns = {"/ServletConsultaCervejaPais"})
public class ServletConsultaCervejaPais extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
         try {
            ...
            cervejasSelecionadas = dao.pesquisaNomeCervejaPorPais(parametro);                                            
