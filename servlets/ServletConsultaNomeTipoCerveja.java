...
@WebServlet(name = "ServletConsultaNomeTipoCerveja", urlPatterns = {"/ServletConsultaNomeTipoCerveja"})
public class ServletConsultaNomeTipoCerveja extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            tipo = dao.pesquisaNomeTipoCerveja(parametro);                                            
