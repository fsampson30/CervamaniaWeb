...
@WebServlet(name = "ServletPesquisaCervejaUsuario", urlPatterns = {"/ServletPesquisaCervejaUsuario"})
public class ServletPesquisaCervejaUsuario extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
           try {
            ...
            cervejasSelecionadas = dao.pesquisaNomeCervejaUsuario(parametro);                                            
